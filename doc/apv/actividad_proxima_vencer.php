...
foreach ($idproyectos as $id):
	...
	$stmt = sqlsrv_query($link,'{CALL sp_doc_notificacion_mensaje (?)}',$params);
	...
	if(isset($dato["mensaje"])):
		...
		$query0= "SELECT * FROM vw_doc_programacion WHERE idprogramacion=".$idprogramacion." AND idestado_actividad NOT IN (1,6)";
