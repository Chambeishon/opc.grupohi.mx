...
class Dashboard_hist extends MX_Controller
{
    ...
    public function actividades(){
        if($this->session->userdata('id')):
            ...
            {
                $prioridad = $this->dashboard_hist_model->obtenerPrioridadesActividad($resultado['idactividad']);
    ...
    public function programacion(){
            ...
            {
                $prioridad = $this->dashboard_hist_model->obtenerPrioridades($resultado['idprogramacion']);
                $resultado['prioridad'] = $prioridad[0];
                $datasource[]=($resultado);
            }
            echo json_encode($datasource);
