...
class Dashboard extends MX_Controller
{
    ...
    public function actividades(){
        if($this->session->userdata('id')):
            ...
            {
                $prioridad = $this->dashboard_model->obtenerPrioridades($resultado['idprogramacion']);
                $resultado['prioridad'] = $prioridad[0];
                $datasource[]=($resultado);
            }
    ...
    public function programacion(){
            ...
            {
                $prioridad = $this->dashboard_model->obtenerPrioridades($idprogramacion);
                $resultado['prioridad'] = $prioridad[0];
                $datasource[]=($resultado);
            }
            echo json_encode($datasource);
...
<fieldset style="background-color:#ebebeb;">
  ...
  <table style="font-size:10px;">
  	<tr>
		<td valign="top"><b>ID TAREA PROGRAMA</b></td><td valign="top"><a href="opc.grupohi.mx/doc/dashboard/index">P-'.$datos[0]["idprogramacion"].'</a></td>
	</tr>
	<tr>
