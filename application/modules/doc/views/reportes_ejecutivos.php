		...
		<div class="panel-body">
			...
			<?php foreach ($proyecto['params'] as $tipo => $params):?>
				<div class="col-md-6">
					...
					<form class="form-horizontal" action="<?=base_url('doc/reportes_ejecutivos/guardar/')?>">
						<div class="col-md-8">
						...
						<table class="table table-striped table-sm">
							...
							<?php foreach ($params as $pa):?>
								<tr>
									...
									<td><a href="<?=base_url('doc/reportes_ejecutivos/eliminar/'. $pa['idparametro_reporte'])?>" onclick="return confirm('confirmar eliminaci&oacute;n');">Eliminar</a></td>
								</tr>
							<?php endforeach;?>
							</tbody>
						</table>
